...
export const appRoutes: Route[] = [
    ...
    { path: 'criacao-drogaria', component: CriacaoDrogariaComponent },
    { path: 'coex-api-oficial', component: CoexApiOficialComponent },
    { path: 'business-manager-meta', component: BusinessManagerMetaComponent },
